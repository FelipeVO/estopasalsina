    ...
    connectedCallback() {
        ...
        fetch('data/products.json')
            ...
            .then(products => {
                ...
                if (!product) {
                    root.innerHTML = `
                        <h2 class="text-3xl font-serif font-bold mb-4">Producto no encontrado</h2>
                ...
                root.innerHTML = `
                    <div class="grid grid-cols-1 md:grid-cols-2 py-20 gap-20 items-start">
                        <div>
                            <img src="${product.image}" alt="${product.title}" class="w-full rounded-lg shadow-lg object-contain">
                        </div>
                        <div class="text-left">
                            ...
                            <a href="productos.html" class="inline-block bg-black text-white px-8 py-3 rounded-full">Ver todos los productos</a>
                        </div>
                    </div>
                `;
            })
